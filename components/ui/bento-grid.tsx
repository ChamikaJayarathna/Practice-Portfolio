...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        // "group/bento shadow-input row-span-1 flex flex-col justify-between space-y-4 relative overflow-hidden rounded-3xl border transition duration-200 hover:shadow-xl",
